...
| `<prefix>.methylation_phenotype_PCs.INT.tsv` | Gavish-Donoho-selected phenotype PCs calculated from the INT BED. |
| `<prefix>.methylation_phenotype_PCs.INT.all.tsv` | Full rotated phenotype-PC matrix from the same INT PCA run, containing every available PC. |
...
- [`workflows/methylation/cohort_aggregation.wdl`](../workflows/methylation/cohort_aggregation.wdl), [`workflows/methylation/connectivity.wdl`](../workflows/methylation/connectivity.wdl), [`workflows/methylation/annotation.wdl`](../workflows/methylation/annotation.wdl), and [`workflows/methylation/qtl_covariates.wdl`](../workflows/methylation/qtl_covariates.wdl): internal workflows for aggregation, connectivity analysis, site annotation, and final QTL covariate preparation. The aggregation workflow calls the annotation workflow directly after producing passing-site metadata.
