...
standalone_input_contract <- parse_expected_contract(c(
    ...
    "estimation_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
    "fit_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
    "export_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
    "downstream_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
...
integrated_input_contract <- parse_expected_contract(c(
    ...
    "export_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
    "downstream_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl-cell-type-specific-expression@sha256:9f7af7c16fa3dc7a0b82c042a40145fa26afce4a96547791e0b29a9e8de4d754\"",
    "qtl_docker_image|String|\"ghcr.io/aou-multiomics-analysis/prepare_qtl@sha256:932f67a09f1635c22a8061a5c98c892393d321e7c17d0401531e7093c469c845\"",
    "preemptible_attempts|Int|2",
    "max_retries|Int|2",
    "min_lm22_overlap|Float|0.80",
    "hspe_marker_fraction|Float|0.10",
