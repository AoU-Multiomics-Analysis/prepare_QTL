...
standalone_input_contract <- parse_expected_contract(c(
    ...
    "dtangle_marker_fraction|Float|0.10",
    "dtangle_quantile_normalize|Boolean|false",
    ...
    "dtangle_cpu|Int|4",
    "dtangle_memory|String|\"32 GB\"",
    "dtangle_disk_gb|Int|100",
...
testthat::test_that("guide states the expression and proportion input contracts", {
    ...
    expect_documented(guide, c(
        ...
        "dtangle uses.*log2\\(CPM \\+ log2_pseudocount\\)",
        "log2\\(LM22 \\+ log2_pseudocount\\)",
        "TCA uses.*linear CPM",
        "gene_type.*protein_coding.*lncRNA",
        "gene-type filtering.*before.*dtangle.*TCA",
        "LM22.*dtangle",
